...
<?php
    $title = "All Tour Summary - TravePal";
?>
        ...
        <tr VALIGN=TOP>
            ...
            ?>
                        ...
                        <div class="box" style="margin-top: 10px;">
                            ...
                            <?php
                            $accomadation_Id = $row["accomadation_id"];
                            ...
                            <?php }else {?>
                               <center> <div class="title">No Accomadation Service Selected</div> </center>
                                <?php }?>
                        </div>
                        <div class="box" style="margin-top: 10px;">
                            ...
                            <?php }else {?>
                               <center> <div class="title">No Vehicle Service Selected</div> </center>
                                <?php }?>
                        </div>
                        <div class="box" style="margin-top: 10px;">
                            ...
                            <?php }else {?>
                               <center> <div class="title">No Tour Guide Service Selected</div> </center>
                                <?php }?>
                        </div> 
                        <div class="box" style="margin-top: 10px;">
                            <?php
