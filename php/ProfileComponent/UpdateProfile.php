                                    ...
                                    <div class="profile-main-wrapper">
                                        ...
                                        <form method="POST" action="UpdateProfile.php">
                                            <div class="line-wrapper">
                                                <label class="line-txt" for="firstName"><b>First Name:</b></label>
                                            ...
                                            <div class="line-wrapper">
                                                <label class="line-txt" for="email"><b>Email:</b></label>
                                                <input class="line-wrapper line-txt" type="email" id="email" name="email" style="width:90%" placeholder="Email" value="<?php echo $row['email']; ?>" required>
                                            </div>
                                            <div class="line-wrapper">
                                                <label class="line-txt" for="address"><b>Address:</b></label>
                                                <input class="line-wrapper line-txt" type="text" id="address" name="address" style="width:90%" placeholder="Address" value="<?php echo $row['address']; ?>" required>
                                            </div>
                                            <center>
