        ...
        <div class="register" style="margin: 62px 0px 60px 0px;">
            <form class="reg-form" method="POST" action="RegisterManager.php" onsubmit="return cheakpassword()">
                <button class="back-button" onclick="history.back()">
                    ...
                    Should be more than 8 characters and less than 16 characters."> -->
                            <br>
                            <button type="submit" id="registerbtn" name="registerbtn" value="registerbtn" class="registerbtn" style="background-color: var(--primarycolor);">Create Manager Account</button>
                            <br>
                        </div>
                        <?php
                        ...
                        if (isset($_POST['registerbtn'])) {
                            ...
                            if ($result) {
                                if ($result->num_rows > 0) {
                                    ...
                                    $sqltwo = "INSERT INTO user (user_Id, first_name, last_name, address, email, password, isActive,  user_type, created_date, otp)
                                    VALUES (0,'$first','$last','$address','$email',NULL,'$isActive', '$userType', '$createdDate', '$otp' )";
