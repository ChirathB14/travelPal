...
<head>
    ...
    <style>
        ...
        *{
        ...
        .right-side .button button, input[type="button"]{
        color: #fff;
        font-size: 18px;
        outline: none;
        border: none;
    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">Wellawatha</div>
        ...
        <div class="email details">
          ...
          <div class="text-one">travelpal@gmail.com</div>
          <div class="text-two">info.travelpal@gmail.com</div>
        </div>
      </div>
      ...
      <form method="POST" action="ContactUS.php">
        ...
        <div class="input-box">
          <input type="email" name="email" placeholder="Enter your email" required pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" >
        </div>
        <div class="input-box message-box">
            <textarea cols="30" rows="10" name="messege" placeholder="Enter your message..." required></textarea>
